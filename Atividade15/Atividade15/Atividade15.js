function validarDados(){
    ...
    if (document.forms.formulario1.elements.comentario.value == "" || document.forms.formulario1.elements.comentario.value.length < 20) {
      alert("É necessário preencher o campo COMENTÁRIO com pelo menos 20 caracteres!");
